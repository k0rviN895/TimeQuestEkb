...
const markersData = {
  ...
  '20 век': {
   ...
   '19 век': {
    ...
    'Памятник клавиатуре': {
      image: require('./assets/19/keyboard.jpg'),
      description: 'Территория входила в состав усадебной застройки. Деревянные дома ремесленников и торговые лавки.'
    },
    'Ельцин Центр': {
      image: require('./assets/19/elcin-center.jpg'),
      description: 'В XIX веке на этом месте находились жилые дома купцов и мещан.'
    },
    'Бизнес-центр "Высоцкий"': {
      image: require('./assets/19/vysotsky.jpg'),
      description: 'В XIX веке это был район купеческих усадеб и торговых лавок.'
    },
    'Екатеринбург Арена': {
      image: require('./assets/19/arena.jpg'),
      description: 'В XIX веке здесь находились пустыри и выгоны для скота.'
    },
    'Новая набережная реки Исеть': {
      image: require('./assets/19/naberezhnaya.jpg'),
      description: 'В XIX веке набережная была неблагоустроенной, с причалами для лодок и складами.'
    },
    'ТЦ "Алатырь"': {
      image: require('./assets/19/alatyr.jpg'),
      description: 'В XIX веке на этом месте находился торговый ряд с лавками.'
    },
    'Парк "Гора Крестов"': {
      image: require('./assets/logo.png'),
      description: 'В XIX веке это было окраинное место с редкими постройками.'
    },
    'Дом Правительства Свердловской области': {
    ...
    'Уралмаш': {
      image: require('./assets/19/uralmash.jpg'),
      description: 'В XIX веке это была окраина города с небольшими мастерскими.'
    },
    'Цирк': {
      image: require('./assets/19/circus.jpg'),
      description: 'В XIX веке цирковые представления проходили во временных шатрах.'
    },
    'Мемориал на площади 1905 года': {
      image: require('./assets/logo.png'),
    ...
    'Малая Свердловская железная дорога': {
      image: require('./assets/logo.png'),
      description: 'В XIX веке здесь проходили первые железнодорожные пути.'
    },
    'Дом Севастьянова': {
      image: require('./assets/19/sevastyanov.jpg'),
